...
\
	...
	3.1) Pour lancer le script, entrer la commande : 'docker compose up migration'\
	3.2) En cas de modification du script (étape 2), entrer la commande : 'docker compose up --build migration'\
